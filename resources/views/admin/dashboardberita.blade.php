...
<head>
  ...
  <title>Dashboard Berita - RSUD Banyuasin</title>
  <!-- Fonts and icons -->
          ...
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <a href="{{ route('admin.berita.create') }}" class="btn btn-primary mb-3 ms-3">Create New Article</a>
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="ps-4">{{ $berita->judul }}</td>
                      <td>{{ $berita->kategori }}</td>
                      <td class="align-middle text-center">{{ $berita->created_at->format('Y-m-d') }}</td>
                      <td class="align-middle text-center">
                        <a href="{{ route('admin.berita.show', $berita->id) }}" class="btn btn-info btn-sm px-3 py-1 me-1">View</a>
                        <a href="{{ route('admin.berita.edit', $berita->id) }}" class="btn btn-warning btn-sm px-3 py-1 me-1">Edit</a>
